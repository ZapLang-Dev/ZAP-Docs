...
Zap v2.2.6 သည် published v2.2.5 နောက်ပိုင်း non-framework core-reliability maintenance release ဖြစ်သည်။ Workspace line-I/O confinement၊ bounded synchronous operation၊ strict locked-build validation၊ URL-port parsing၊ cycle-safe test discovery၊ process descendant termination၊ registry-test isolation နှင့် cross-platform editor/test parity များကို harden လုပ်ထားသည်။ Parser၊ runtime language syntax သို့မဟုတ် Framework/Web/App/IoT behavior အသစ် မထည့်သွင်းပါ။
...
v2.2.6 maintenance အလုပ်များသည် ယခင် release tag နှင့် published asset အားလုံးကို ထိန်းသိမ်းထားပါသည်။ Source change များသည် bounded reliability၊ project validation၊ test-discovery safety၊ process cleanup၊ registry-test determinism၊ catalog/editor parity နှင့် bilingual documentation အတွင်းသာ ကန့်သတ်ထားပါသည်။ Future AST/typed-IR checker redesign၊ syntax-aware formatter/linter expansion၊ race-resistant descriptor-relative filesystem API၊ complete DNS-to-connection pinning နှင့် universal descendant cleanup များသည် preserved language contract မပြောင်းလဲဘဲ သီးခြား implement/verify မလုပ်မချင်း explicit follow-up boundary အဖြစ် ဆက်ရှိပါသည်။
